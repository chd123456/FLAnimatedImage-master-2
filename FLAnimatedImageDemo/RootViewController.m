...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSURL *url1 = [[NSBundle mainBundle] URLForResource:@"rock1" withExtension:@"gif"];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        NSURL *url2 = [NSURL URLWithString:@"http://www.sznews.com/humor/attachement/gif/site3/20140415/4487fcd7fc6614b6bfaa17.gif"];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        NSURL *url3 = [NSURL URLWithString:@"http://img.gaoxiaogif.cn/GaoxiaoGiffiles/images/2015/08/06/yingwuyongjiaocaimaomi.gif"];
...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        _titleLabel.text = @"Hida 的测试程序 gif动态图";
...
- (UILabel *)subtitleLabel
{
    if (!_subtitleLabel) {
        ...
        _subtitleLabel.text = @"缓存大小为每个图像分别进行了优化";
...
- (UIButton *)memoryWarningButton
{
    if (!_memoryWarningButton) {
        ...
        [_memoryWarningButton setTitle:@"模拟内存警告" forState:UIControlStateNormal];
